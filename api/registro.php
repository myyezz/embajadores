...
function correonuevacuenta($emailx, $nombre, $celular, $nombretienda, $direcciontienda, $tallafranela) {
   ...
   $sTexto  = '<div style="width: 388.65px;">
                  <img src="http://embajadores.myyezz.com/images/LOGO.png" width="220" height="50.23" />
               </div>';
   ...
   $sTexto .= 'Ingresa en <a href="http://embajadores.myyezz.com/admin">este enlace</a> para mirar sus datos y aprobar su solicitud<br/><br/>';
