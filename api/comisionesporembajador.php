...
$query = "select * from comision where idembajador=$idembajador and (fecha>='$desde' and fecha<='$hasta') and status<>'rechazada' order by pagada desc, fecha, imei";
...
$respuesta .= ',"registrosx": ['. implode(',', $listax)    .']';
$respuesta .= '}';
